...
static constexpr VkExtent2D SWAPCHAIN_EXTENT = {500, 500};
...
public:
    Renderer()
    {
        ...
        window = glfwCreateWindow(SWAPCHAIN_EXTENT.width, SWAPCHAIN_EXTENT.height, "Hello Triangle", nullptr, nullptr);
        ...
        s_swapChain.imageFormat = SWAPCHAIN_IMAGE_FORMAT;
        s_swapChain.imageColorSpace = VK_COLOR_SPACE_SRGB_NONLINEAR_KHR;
        s_swapChain.imageExtent = SWAPCHAIN_EXTENT;
        ...
        for (size_t i = 0; i < swapChainImageCount; i++)
        {
            ...
            s_imageView.format = SWAPCHAIN_IMAGE_FORMAT;
        ...
        s_pipelineRendering.pColorAttachmentFormats = &SWAPCHAIN_IMAGE_FORMAT;
        ...
        vkAllocateCommandBuffers(device, &s_commandBuffer, &commandBuffer);
        ...
        vkCreateSemaphore(device, &s_semaphore, nullptr, &imageAvailableSemaphore);
        vkCreateFence(device, &s_fence, nullptr, &inFlightFence);

        renderFinishedSemaphores.resize(swapChainImages.size());
        for(VkSemaphore &semaphore : renderFinishedSemaphores)
            vkCreateSemaphore(device, &s_semaphore, nullptr, &semaphore);
    ...
    void run()
    {
        while (!glfwWindowShouldClose(window))
        {
            ...
            vkBeginCommandBuffer(commandBuffer, &s_begin);
            ...
            vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT, 0, 0, nullptr, 0, nullptr, 1, &s_imageMemoryBarrier);
            ...
            vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT, VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT, 0, 0, nullptr, 0, nullptr, 1, &s_imageMemoryBarrier);
